...
- [x] 02-01-PLAN.md — Wave 0 session/bind/JWT unit tests + jose@4.15.9
...
- [x] 02-03-PLAN.md — Session-gated approve/reject/cancel/delete/bulk
- [x] 02-04-PLAN.md — Session-gated dashboard/calendar GET routes
- [x] 02-05-PLAN.md — Service-role identity client + close test-connection listing
- [x] 02-07-PLAN.md — Dashboard/calendar fetch swap + stop browser domain client

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 02-06-PLAN.md — Tenant RLS + anon REVOKE + local schema push + pgTAP
...
- [x] 03-01-PLAN.md — Wave 0 seed planner + card-order unit tests

**Wave 2** *(03-02 and 03-03 parallel after 03-01)*

- [x] 03-02-PLAN.md — GET self-heal tracer + live remaining_days bind
- [x] 03-03-PLAN.md — RPC seed in both onboarding functions + local schema push

**Wave 3** *(blocked on 03-02)*

- [ ] 03-04-PLAN.md — Empty/error/partial/order per UI-SPEC
...
| 3. Live Remaining Days | 3/4 | In Progress|  |
